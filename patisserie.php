        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Pâtisserie</h1>
    ...
    <body>
        <div class="container">
            ...
            <section class="description">
                <h4>Description</h4>
                <p>Élevez vos compétences culinaires avec notre formation complète en pâtisserie, qui vous guide à travers les techniques artisanales et modernes, la création de desserts raffinés et l'utilisation des ingrédients les plus fins, tout en vous fournissant des conseils pratiques et des astuces de professionnels pour vous permettre de maîtriser l'art de la pâtisserie et de créer des délices sucrés qui impressionneront à coup sûr vos clients ou invités.</p>
            </section>
