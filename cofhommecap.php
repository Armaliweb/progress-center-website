        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">COIFFURE HOMME</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Formation Coiffure Homme</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Développez vos compétences en coiffure  avec notre formation complète, qui vous guide à travers les dernières techniques, tendances et astuces pour créer des coiffures élégantes et innovantes, tout en vous préparant à exceller dans un secteur dynamique et en constante évolution.</p>
            </section>
