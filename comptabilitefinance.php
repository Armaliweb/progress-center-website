        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">COMPTABILITÉ & FINANCE
                    </h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>DIPLÔME COMPTABILITÉ FINANCE</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p> Au Progress Professional Center, formez-vous pour devenir agent de banque, comptable d’entreprise, gestionnaire commercial, analyste financier, gestionnaire de paie, et bien plus encore. Progressez vers l'excellence professionnelle avec nous !</p>
            </section>
