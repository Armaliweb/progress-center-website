...
<head>
    <meta charset="utf-8">
    <title>Marketing Digital & Social Média</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">MARKETING DIGITAL</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">DOMAINE Marketing Digital & Social Média</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="marketing&multimedia.php" class="dropdown-item">
                                <img class="img-fluid" src="img/a1.jpg" alt="Marketing & Multimédia">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="marketing&multimedia.php" >
                                <h5 class="mb-0">MARKETING & MULTIMÉDIA</h5>
                            </a>
                        </div>
                    </div>
                </div>
