...
<title>Formation BB Lips - Progress Professionnel Center</title>
...
.hero { background:url('img/bb-lips.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation BB Lips</h1>
    <p>Apprenez les techniques de pigmentation semi-permanente des lèvres</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Formation professionnelle pour maîtriser le BB Lips, pigmentation douce et naturelle,
          techniques modernes et sécurité des clients.
        </p>
      </div>
    </div>
    <img src="img/bb-lips2.jpg" alt="BB Lips" class="img-fluid rounded shadow mt-4" style="max-width:400px; width:100%; height:auto;">
  </section>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-bb-lips.php" method="post">
          <div class="mb-3">
          ...
          <input type="hidden" name="formation" value="BB Lips">
