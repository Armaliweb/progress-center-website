...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $age     = (int) $_POST['age'];
    $contact = $conn->real_escape_string($_POST['parcours']);
    $option  = $conn->real_escape_string($_POST['option']);
    $formation = "Manucure & Pédicure";

    $sql = "INSERT INTO inscriptions_manicure (nom, age, contact, formule)
            VALUES ('$nom', $age, '$contact', '$option')";
...
<title>Manucure & Pédicure - Progress Professionnel Center</title>
...
.hero { background:url('img/manicure-hero.jpg') center/cover no-repeat; height:420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Manucure & Pédicure</h1>
    <p>Perfectionnez vos compétences pour offrir des soins de mains et pieds professionnels</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Une formation complète pour apprendre les techniques professionnelles de manucure et pédicure,
          l’hygiène, le nail art et le soin des ongles, adaptée aux débutants comme aux professionnels.
        </p>
      </div>
    </div>
    <img src="img/manicuree.jpg" alt="Manucure & Pédicure" class="img-fluid rounded shadow mt-4" style="max-width:800px;">
  </section>
      ...
      <div class="col-md-5">
        <div class="card card-option">
          ...
          <div class="card-body">
            ...
            <p class="price">175TND au lieu de 350TND</p>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <form action="" method="post">
          ...
          <div class="mb-3">
            <label for="parcours" class="form-label">Email ou téléphone</label>
          ...
          <input type="hidden" name="formation" value="Manucure & Pédicure">
