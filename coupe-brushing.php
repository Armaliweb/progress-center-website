...
<title>Formation Coupe & Brushing - Progress Professionnel Center</title>
...
.hero { background:url('img/coupe-brushing.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Coupe & Brushing</h1>
    <p>Perfectionnez vos techniques de coupe et brushing modernes</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Apprenez les techniques avancées de coupe et brushing pour hommes et femmes, avec un programme complet adapté aux dernières tendances capillaires.
        </p>
      </div>
    </div>
    <img src="img/coupe-brushing2.jpg" alt="Coupe & Brushing" class="img-fluid rounded shadow mt-4" style="max-width:600px; width:100%; height:auto;">
  </section>
      ...
      <div class="col-md-5">
        <div class="card card-option">
          ...
          <div class="card-body">
            ...
            <p>Techniques rapides de coupe et brushing pour maîtriser l’essentiel.</p>
          </div>
        </div>
      </div>
        </div>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-coupe-brushing.php" method="post">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="option" name="option" required>
              <option value="intensive">Intensive (1 mois) - 250TND</option>
            </select>
          </div>
          <input type="hidden" name="formation" value="Coupe & Brushing">
