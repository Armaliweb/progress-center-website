...
<head>
    <meta charset="utf-8">
    <title>DÉVELOPPEUR – PROGRAMMEUR</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">DÉVELOPPEUR – PROGRAMMEUR
                    </h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>FORMATION DÉVELOPPEUR – PROGRAMMEUR</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Le programme de formation développeur – programmeur vous permet d’obtenir 8 certificats agrées dans des langages informatique les plus demandés au marcher de travail .</p>
            </section>
            ...
            <section class="niveau-demande">
                <h4>Certification</h4>
                 <p>✅ Développeur – Programmeur
                </p>
                ✅ Développeur site web  statique (HTML 5 – CSS 3 – JavaScript)

                <P>✅ Développeur site web dynamique (PHP 5 – MYSQL – JQUERY – BootStrap)
                </P>
                <p>✅ Programmation java
                </p>
                 <p>✅ Programmation J2EE</p>
                 <p>✅ Développement Android</p>
                 <p>✅ Conception et développement jeux vidéo (Unity)</p>
                 <p>✅ Anglais technique et communication</p>
