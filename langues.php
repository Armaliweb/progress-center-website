        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">LANGUES</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Langues</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">DOMAINE LANGUES</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="anglais.php" class="dropdown-item">
                                <img class="img-fluid" src="img/anglais.jpg" alt="anglais">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="francais.php" class="dropdown-item">
                                <img class="img-fluid" src="img/francais.jpg" alt="francais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="francais.php" >
                                <h5 class="mb-0">Français</h5>
                                <small>PACK FORMATION</small>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="espagnol.php" class="dropdown-item">
                                <img class="img-fluid" src="img/espa.jpg" alt="espagnol">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="espagnol.php" >
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="italien.php" class="dropdown-item">
                                <img class="img-fluid" src="img/italien.jpg" alt="italien">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="italien.php" >
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="allemand.php" class="dropdown-item">
                                <img class="img-fluid" src="img/allmand.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="allemand.php" >
