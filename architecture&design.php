        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">ARCHITECTURE & DESIGN
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Architecture & Design</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<body>
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">DOMAINE ARCHITECTURE & DESIGN</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="design-graphic.php" class="dropdown-item">
                                <img class="img-fluid" src="img/a3.jpg" alt="Infographie Design">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="design-graphic.php" >
                                <h5 class="mb-0">INFOGRAPHIE DESIGN</h5>
                                <small>DIPLÔME BTP</small>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="architectured'interieur.php" class="dropdown-item">
                                <img class="img-fluid" src="img/archi.png" alt="Marketing & Multimédia">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="architectured'interieur.php" >
                                <h5 class="mb-0">ARCHITECTURE D’INTERIEUR</h5>
                                <small>DIPLÔME BTS</small>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
        <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
            <div class="team-item bg-light">
                <div class="overflow-hidden">
                    <a href="packarchitecture.php" class="dropdown-item">
                        <img class="img-fluid" src="img/architecture.jpg" alt="Infographie Design">
                    </a>
                </div>
                <div class="text-center p-4">
                    <a href="packarchitecture.php" >
                        <h5 class="mb-0">ARCHITECTURE & DESIGN</h5>
