...
<head>
    <meta charset="utf-8">
    <title>ASSISTANTE DE DIRECTION</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">ASSISTANT DE DIRECTION</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Formation Assistant de Direction</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Le Centre Progress Profisionnel offre Le programme de formation en assistant de direction et commercial vous permet d’obtenir 4 certificats agrées, dans les différents modules pratiques, tel que le management, l’informatique bureautique, le français de communication, la comptabilité, le marketing et design.</p>
            </section>
            ...
            <section class="niveau-demande">
                <h4>Certification</h4>
                 <p>✅ FORMATION ASSISTANT(E) DE DIRECTION & COMMERCIAL (Management -Marketing)</p>
                 <p>✅ INFORMATIQUE BUREAUTIQUE (Windows – Word – Excel – Power Point)</p>    
                 <p>✅ FRANÇAIS DE COMMUNICATION</p> 
