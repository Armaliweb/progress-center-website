    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/19.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">350<sup>TND</sup></h6>
                        ...
                        <h5 class="mb-4">Allemand général niveau A</h5>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/20.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">400<sup>TND</sup></h6>
                        <p class="text-muted mb-3">
                            <i class="fa fa-star text-primary"></i>
                            <i class="fa fa-star text-primary"></i>
                            <i class="fa fa-star text-primary"></i>
                        ...
                        <h5 class="mb-4">Allemand général niveau B</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/22.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">350<sup>TND</sup></h6>
                        <p class="text-muted mb-3">
                        ...
                        <h5 class="mb-4">Révision Allemand (OSD/TELK)</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/21.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        ...
                        <h5 class="mb-4">Coaching privé allemand</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>Selon la demande</small>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
            <h2 class="section-title bg-white text-center text-primary px-3">Inscription au cours</h2>
            <p>Remplissez le formulaire ci-dessous pour vous inscrire à notre cours d'allemand.</p>
        </div>

        <div class="row justify-content-center">
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
                <div class="bg-light rounded p-4 p-md-5">
                    <form action="save_inscription.php" method="POST" class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="option_formation" class="form-label">Option de formation</label>
                            <select class="form-select" id="option_formation" name="option_formation" required>
                                <option value="">Sélectionner</option>
                                <option value="Allemand général niveau A">Allemand général niveau A</option>
                                <option value="Allemand général niveau B">Allemand général niveau B</option>
                                <option value="Révision Allemand (OSD/TELK)">Révision Allemand (OSD/TELK)</option>
                                <option value="Coaching privé allemand">Coaching privé allemand</option>
                            </select>
                        </div>
                        <div class="col-12 text-center">
                            <button type="submit" class="btn btn-primary px-5 py-2">S'inscrire</button>
                        </div>
                    </form>
                </div>
            </div>
