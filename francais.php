<?php
session_start();
require_once 'config.php'; // Make sure this contains your PDO connection $pdo
?>
<!DOCTYPE html>
<html lang="en">
...
<script>
    // Hide spinner once page fully loads
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h2 class="section-title bg-white text-center text-primary px-3">Nos cours</h2>
        </div>
        <br><br>
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/8.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">260<sup>TND</sup></h6>
                        ...
                        <h5 class="mb-4">Français général extensif</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>30 Hrs</small>
                        <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>4 fois par Semaine</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/9.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">150<sup>TND</sup></h6>
                        <p class="text-muted mb-3">
                            <i class="fa fa-star text-primary"></i>
                            <i class="fa fa-star text-primary"></i>
                            <i class="fa fa-star text-primary"></i>
                        ...
                        <h5 class="mb-4">Français de communication</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>20 Hrs</small>
                        <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>2 fois par Semaine</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/10.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">Sur Devis</h6>
                        <p class="text-muted mb-3">
                            <i class="fa fa-star text-primary"></i>
                            <i class="fa fa-star text-primary"></i>
                            <i class="fa fa-star text-primary"></i>
                        ...
                        <h5 class="mb-4">Coaching privé français</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>selon la choix</small>
                        <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>selon la demande</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/11.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">280<sup>TND</sup></h6>
                        <p class="text-muted mb-3">
                            <i class="fa fa-star text-primary"></i>
                            <i class="fa fa-star text-primary"></i>
                            <i class="fa fa-star text-primary"></i>
                        ...
                        <h5 class="mb-4">Français des affaires</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>20 Hrs</small>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/13.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">Sur Devis</h6>
                        <p class="text-muted mb-3">
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/12.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">Sur Devis</h6>
                        <p class="text-muted mb-3">
                        ...
                        <h5 class="mb-4">DELF / DALF</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>20 Hrs</small>
                        <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>3 fois par Semaine</small>
                    </div>
                </div>
            </div>
...
<div class="container my-5">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <!-- Form to submit new inscription -->
            <form action="save_inscription_francais.php" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="option_formation" class="form-label">Type de cours</label>
                    <select class="form-select" id="option_formation" name="option_formation" required>
                        <option value="">-- Sélectionner un cours --</option>
                        <option value="Français général extensif">Français général extensif</option>
                        <option value="Français de communication">Français de communication</option>
                        <option value="Coaching privé français">Coaching privé français</option>
                        <option value="Français des affaires">Français des affaires</option>
                        <option value="TEF / TCF">TEF / TCF</option>
