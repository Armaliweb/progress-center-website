        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">MANAGEMENT & DESIGN</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Management & Design</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">DOMAINE MANAGEMENT & DESIGN</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="marketingdigital.html" class="dropdown-item">
                                <img class="img-fluid" src="img/12.jpg" alt="anglais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="marketingdigital.html" >
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="gestioncommercial.html" class="dropdown-item">
                                <img class="img-fluid" src="img/13.jpg" alt="francais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="gestioncommercial.html" >
                                <h5 class="mb-0">Gestion Commercial</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="commerceinternational.html" class="dropdown-item">
                                <img class="img-fluid" src="img/14.jpg" alt="espagnol">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="commerceinternational.html" >
                                <h5 class="mb-0">Commerce International</h5>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="commercialvoyage.html" class="dropdown-item">
                                <img class="img-fluid" src="img/15.jpg" alt="italien">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="commercialvoyage.html" >
                                <h5 class="mb-0">Agent de voyage et de billeterie</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="formationassistant.html" class="dropdown-item">
                                <img class="img-fluid" src="img/16.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="formationassistant.html" >
                                <h5 class="mb-0">Formation Assistant de Direction</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="formationcomptabilite.html" class="dropdown-item">
                                <img class="img-fluid" src="img/17.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="allemand.html" >
                                <h5 class="mb-0">Formation Comptabilité Pratique</h5>
                            </a>
                        </div>
                    </div>
                </div>
