        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">METIERS</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">Progress</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Formations</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Pack Formations</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Métiers</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">FORMATION METIERS</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="esthetique.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/1.jpg" alt="anglais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="esthetique.html" >
                                <h5 class="mb-0">Esthétique</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="coiffemme.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/2.jpg" alt="francais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="coiffemme.html" >
                                <h5 class="mb-0">Coiffure Femme</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="coifhomme.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/3.jpg" alt="espagnol">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="coifhomme.html" >
                                <h5 class="mb-0">Coiffure Homme</h5>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="styl.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/4.jpg" alt="italien">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="styl.html" >
                                <h5 class="mb-0">Stylisme Modélisme</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="tatouage.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/5.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="tatouage.html" >
                                <h5 class="mb-0">Tatouage & Design</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="patronage.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/6.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="patronage.html" >
                                <h5 class="mb-0">Patronage</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="systheme.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/7.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="systheme.html" >
                                <h5 class="mb-0">Caméra de Surveillance & Système d’Alarme</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="maintenance.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/8.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="maitenance.html" >
                                <h5 class="mb-0">Maintenance Informatique</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="patisserie.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/9.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="patisserie.html" >
                                <h5 class="mb-0">Pâtisserie</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="cuisine.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/10.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="cuisine.html" >
                    ...
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="sport.html" class="dropdown-item">
                                <img class="img-fluid" src="img/metier/11.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="sport.html" >
                                <h5 class="mb-0">Coaching Sportif                                                                                                                                                                                                                                                         </h5>
                            </a>
                        </div>
                    </div>
                </div>
