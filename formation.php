<?php
// Example list of courses with domains
$courses = [
  ["title" => "Digital Marketing Basics", "domain" => "Marketing Digital & Social Média"],
  ["title" => "Social Media Strategies", "domain" => "Marketing Digital & Social Média"],
  ["title" => "Introduction to Programming", "domain" => "Informatique & Multimédia"],
  ["title" => "Accounting 101", "domain" => "Comptabilité & Finance"],
  ["title" => "Photoshop for Beginners", "domain" => "Design Graphique"],
  ["title" => "AutoCAD Essentials", "domain" => "Architecture & Design"],
  ["title" => "English Grammar", "domain" => "Langues"],
  ["title" => "Basic Plumbing", "domain" => "Métiers"],
  ["title" => "Advanced Excel", "domain" => "Comptabilité & Finance"],
];

// Count formations by domain
$domainCounts = [];
...
<?php
// Simulated list of all courses
$courses = [
  ["title" => "Soin du visage", "domain" => "Esthétique"],
  ["title" => "Makeup Professionnel", "domain" => "Esthétique"],
  ["title" => "Couture", "domain" => "Couture"],
  ["title" => "Formation Coiffure", "domain" => "Coiffure"],
  ["title" => "Coloration Expert", "domain" => "Coiffure"],
  ["title" => "Langue Anglaise", "domain" => "Langues"],
  ["title" => "Langue Française", "domain" => "Langues"],
  ["title" => "HTML & CSS", "domain" => "Informatique"],
  ["title" => "Excel Débutant", "domain" => "Informatique"]
];

// Domains to display
$domains = [
  ["name" => "Esthétique", "icon" => "💄", "description" => "Beauté, soins de la peau, maquillage"],
  ["name" => "Coiffure", "icon" => "💇‍♀️", "description" => "Coupe, couleur, coiffage"],
  ["name" => "Couture", "icon" => "🧵", "description" => "Bien-être, Couture techniques, techniques"],
  ["name" => "Informatique", "icon" => "💻", "description" => "Bureautique, développement, IA"],
  ["name" => "Langues", "icon" => "📚", "description" => "Anglais, français, communication"],
  ["name" => "Marketing", "icon" => "🧑‍🏫", "description" => "Marketing digital, réseaux sociaux, publicité"],
  ["name" => "Design", "icon" => "🎨", "description" => "photoshop, illustrator, Fegma"],
  ["name" => "Trading", "icon" => "📊", "description" => "Success, service, money"]
];

// Link for each domain
$domainLinks = [
  "Esthétique" => "esthetique.php",
  "Coiffure" => "coiffure.php",
  "Couture" => "couture.php",
  "Informatique" => "informatique&multimedia.php",
  "Langues" => "langues.php",
  "Marketing" => "MARKETINGDIGITAL&SOCIALMEDIA.php",
  "Design" => "DESIGNGRAPHIC.php",
  "Trading" => "trading.php"
];

// Count how many courses in each domain
$domainCounts = [];
foreach ($courses as $course) {
  $domain = $course['domain'];
  if (!isset($domainCounts[$domain])) {
...
<div class="container mt-5">
  <div class="row">
    <?php foreach ($domains as $domain): 
      ...
      $count = isset($domainCounts[$name]) ? $domainCounts[$name] : 0;

      // Déterminer le lien
      $link = "#"; // valeur par défaut
      if (isset($domainLinks[$name])) {
        if (is_array($domainLinks[$name])) {
          // Pour Coiffure : rediriger vers la première page (coifhomme.html)
          $link = $domainLinks[$name][0];
        } else {
          $link = $domainLinks[$name];
        }
      }
    ?>
