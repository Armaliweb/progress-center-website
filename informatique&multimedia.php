...
<head>
    <meta charset="utf-8">
    <title>INFORMATIQUE & MULTIMEDIA</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">INFORMATIQUE & MULTIMEDIA</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Informatique & Multimédia</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">FORMATION INFORMATIQUE & MULTIMEDIA</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="communitymanager.php" class="dropdown-item">
                                <img class="img-fluid" src="img/formation/1.jpg" alt="anglais">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="monteurson.php" class="dropdown-item">
                                <img class="img-fluid" src="img/formation/2.jpg" alt="francais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="monteurson.php" >
                                <h5 class="mb-0">Monteur Son & Video</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="developpeur.php" class="dropdown-item">
                                <img class="img-fluid" src="img/formation/3.jpg" alt="espagnol">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="developpeur.php" >
                                <h5 class="mb-0">Développeur / Programmeur</h5>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="webmaster.php" class="dropdown-item">
                                <img class="img-fluid" src="img/formation/4.jpg" alt="italien">
                            </a>
                        </div>
                        <div class="text-center p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="infographiste.php" class="dropdown-item">
                                <img class="img-fluid" src="img/formation/5.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="infographiste.php" >
                                <h5 class="mb-0">Infographiste</h5>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="office.php" class="dropdown-item">
                                <img class="img-fluid" src="img/formation/6.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="infographiste.php" >
                                <h5 class="mb-0">Microsoft Office</h5>
                            </a>
                        </div>
                    </div>
                </div>
