        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">ARCHITECTURE D’INTERIEUR
                    </h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>DIPLÔME BTS ARCHITECTURE D’INTERIEUR:</h3>

            <h3> DECORATION & DESIGN D’INTERIEUR</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Le Centre Progress Professionnel vous propose un diplôme homologué en BTS décoration et design d’intérieur. Ce programme riche en pratique vous permet de maîtriser les logiciels 2D – 3D d’architecture et de design pour la CAO (Conception Assistée par Ordinateur) et la DAO (Dessin Assisté par Ordinateur). Obtenez votre diplôme homologué et des certifications nationales grâce à nos partenariats avec Adobe et Autodesk. </p>
            </section>
            
            
            
            <section class="metiers">
                <h4>Les métiers à travailler ?</h4>
                <ul>
                    <li>Décorateur d’intérieur</li>
                    <li>Designer d’éspace</li>
            ...
            <section class="niveau-demande">
                <h4>Niveau demandé</h4>
                <p>Baccalauréat ou BTP homologué dans une spécialité similaire</p>
            </section>
            
            <section class="niveau-sortie">
                <h4>Niveau de sortie</h4>
                <p>BTS: Brevet Technicien Supérieur (équivalent BAC + 2)</p>
            </section>
