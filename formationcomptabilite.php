...
<head>
    <meta charset="utf-8">
    <title>COMPTABILITE PRATIQUE</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">COMPTABILITE PRATIQUE</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Formation Comptabilité Pratique</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Le Centre Progress Profisionnel offre e programme de formation en comptabilité pratique vous permet d’obtenir 4 certificats agrées dans les différents niveaux et logiciels de comptabilité.</p>
            </section>
