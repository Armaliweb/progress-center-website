...
<title>Formation Hanna - Progress Professionnel Center</title>
...
.hero { background:url('img/hanna.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Hanna</h1>
    <p>Maîtrisez l’art de la coloration et de l’embellissement naturel avec les techniques Hanna</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Formation professionnelle pour apprendre l'application de Hanna, techniques de coloration naturelle,
          et perfectionner vos compétences pour sublimer vos clients.
        </p>
      </div>
    </div>
    <img src="img/hanna2.jpg" alt="Hanna" class="img-fluid rounded shadow mt-4" style="max-width:600px; width:100%; height:auto;">
  </section>
      ...
      <div class="col-md-5">
        <div class="card card-option">
          ...
          <div class="card-body">
            ...
            <p class="price">180TND au lieu de 360TND</p>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-hanna.php" method="post">
          <div class="mb-3">
          ...
          <input type="hidden" name="formation" value="Hanna">
