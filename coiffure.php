...
<head>
    <meta charset="UTF-8">
    <title>Coiffure - Choix de Formation</title>
    ...
    <style>
        ...
        .hero {
            background: url('img/coifhero.jpg') center/cover no-repeat;
            height: 350px;
            position: relative;
            color: white;
            display: flex;
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-5">
            <div class="card choice-card">
                <img src="img/ca.jpg" alt="Formation Accélérée">
                <div class="card-body">
                    <h4 class="card-title">Formation Accélérée</h4>
                    <p>Programme intensif pour apprendre la coiffure rapidement.</p>
                    <a href="coiffure2.php" class="btn btn-primary">Choisir</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="card choice-card">
                <img src="img/cc.jpg" alt="Formation Continue">
                <div class="card-body">
                    <h4 class="card-title">Formation Continue</h4>
                    <p>Formation progressive et complète pour maîtriser toutes les techniques.</p>
                    <a href="coiffure1.php" class="btn btn-primary">Choisir</a>
                </div>
            </div>
        </div>
