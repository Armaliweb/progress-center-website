...
<head>
    <meta charset="utf-8">
    <title>LANGUES & COMMUNICATION</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown"> LANGUES & COMMUNICATION</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Langues & Communication</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">FORMATION LANGUES & COMMUNICATION</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="ANGLAIS1.html" class="dropdown-item">
                                <img class="img-fluid" src="img/langue/1.jpg" alt="anglais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="ANGLAIS1.html" >
                                <h5 class="mb-0">ANGLAIS</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="FRANCAIS1.html" class="dropdown-item">
                                <img class="img-fluid" src="img/langue/2.jpg" alt="francais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="FRANCAIS1.html" >
                                <h5 class="mb-0">FRANCAIS</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="ESPAGNOL1.html" class="dropdown-item">
                                <img class="img-fluid" src="img/langue/3.jpg" alt="espagnol">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="ESPAGNOL1.html" >
                                <h5 class="mb-0">ESPAGNOL</h5>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="ITALIEN1.html" class="dropdown-item">
                                <img class="img-fluid" src="img/langue/4.jpg" alt="italien">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="ITALIEN1.html" >
                                <h5 class="mb-0">ITALIEN</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="ALLEMAND1.html" class="dropdown-item">
                                <img class="img-fluid" src="img/langue/5.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="ALLEMAND1.html" >
                                <h5 class="mb-0">ALLEMAND</h5>
                            </a>
                        </div>
                    </div>
                </div>
