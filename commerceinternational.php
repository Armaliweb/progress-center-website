        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">COMMERCE INTERNATIONNAL</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Formation Commerce Internationnal</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Le Centre Progress Profisionnel vous offre Le programme de formation en commerce international vous permet d’obtenir 4 certificats agrées, dans les différents modules pratiques, tel que le transport et logistique, la gestion du stock , l’approvisionnement, l’anglais d’affaire et communication.</p>
            </section>
            ...
            <section class="niveau-demande">
                <h4>Certification</h4>
                 ...
                 <p>✅ GESTION DES STOCKS ET APPROVISIONNEMENT</p> 
                  <p>✅ FORMATION ANGLAIS D’AFFAIRE ET COMMUNICATION</p>     
            </section>
