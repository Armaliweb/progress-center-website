...
<title>Formation Brow Lift - Progress Professionnel Center</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
<style>
:root { --accent: #ff9671; --accent-2: #ffc75f; --bg-light: #fdfdfd; --text-dark: #2d2d2d;}
body { font-family: 'Poppins', sans-serif; background: var(--bg-light); color: var(--text-dark);}
.hero { background:url('img/browlift2.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Brow Lift</h1>
    <p>Apprenez la technique professionnelle de rehaussement des sourcils pour un regard sublimé.</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Formation pratique et professionnelle sur la technique Brow Lift : restructuration,
          rehaussement et soin des sourcils pour un regard intense et naturel.
        </p>
      </div>
    </div>
    <img src="img/browlift.jpg" alt="Brow Lift" class="img-fluid rounded shadow mt-4" style="max-width:600px; width:100%; height:auto;">
  </section>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-md-5">
        <div class="card card-option">
          ...
          <div class="card-body">
            <p>Durée : <strong>2 Semaines</strong></p>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-browlift.php" method="post">
          <div class="mb-3">
          ...
          <input type="hidden" name="formation" value="Brow Lift">
...
<footer class="text-center mt-5">
  © 2025 Progress Professionnel Center - Tous droits réservés
</footer>
