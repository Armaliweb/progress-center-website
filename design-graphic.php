...
<head>
    ...
    <meta content="Formation Infographie, Design Graphique, Photoshop, Illustrator" name="keywords">
    <meta content="Formation Infographie et PAO : Apprenez Photoshop et Illustrator pour devenir Designer Graphique, Infographiste ou Concepteur multimédia." name="description">
...
<?php endif; ?>
    ...
    <!-- Content Start -->
    <div class="container">
        <h3>Formation Infographie PAO</h3>
        <br><br>

        <section class="description">
            <h4>Description</h4>
            <p>Le Centre Progress Professionnel vous propose une formation complète en <b>Infographie et PAO</b>. Vous apprendrez à maîtriser les logiciels les plus utilisés dans le design graphique (Photoshop, Illustrator...), afin de créer des visuels professionnels pour l’impression, le multimédia et le marketing digital.</p>
        </section>

        <section class="metiers">
            <h4>Débouchés professionnels</h4>
            <ul>
                <li>Designer 2D/3D</li>
                <li>Infographiste (Conception & Impression)</li>
                <li>Concepteur de jeux vidéo</li>
            </ul>
        </section>

        <section class="niveau-demande">
            <h4>Niveau d’admission</h4>
            <p>2ème, 3ème ou 4ème année secondaire (sans BAC) ou CAP homologué dans une spécialité similaire.</p>
        </section>

        <section class="certifications">
            <h4>Certifications incluses</h4>
            <p>Illustrator</p>
            <p>Photoshop</p>
        </section>
...
?>
    ...
    <script>
        window.addEventListener("load", function () {
            ...
            if (spinner) {
                spinner.style.display = "none"; // cache le spinner quand la page est chargée
            }
        });
    </script>
</body>
