        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Domaines</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                            <h4 class="section-title bg-white text-center text-primary px-3" style="color: #00a4ff; text-align: center;">Comment choisir mon domaine avec ou sans bac ?</h4>   
                        </div>
                        <br>
                        <p>Que vous soyez étudiant, en recherche d'emploi, professionnel ou autre, avec un niveau scolaire universitaire ou secondaire, Progress Professional Center est là pour vous !</p>
                        <p>Notre centre de formation privé propose une vaste gamme de formations adaptées à vos intérêts et objectifs.</p>
                        <p>Nos experts sont à votre disposition pour vous guider dans le choix du domaine de formation qui vous correspond le mieux.</p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="container">
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <a href="MARKETINGDIGITAL&SOCIALMEDIA.html"><img class="img-fluid" src="img/a/1.jpg" alt="FORMATION ACCÉLÉRÉE"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <a href="informatique&multimedia.html"><img class="img-fluid" src="img/a/2.jpg" alt="FORMATION ACCÉLÉRÉE"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <a href="comptabilite&finance.html"><img class="img-fluid" src="img/a/3.jpg" alt="PACK FORMATION"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <a href="architecture&design.html"><img class="img-fluid" src="img/a/4.jpg" alt="Social média & Digital marketing"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <a href="DESIGNGRAPHIC.html"><img class="img-fluid" src="img/a/5.jpg" alt="FORMATION ACCÉLÉRÉE"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <a href="langues.html"><img class="img-fluid" src="img/a/6.jpg" alt="PACK FORMATION"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <a href="metiers.html"><img class="img-fluid" src="img/a/7.jpg" alt="PACK FORMATION"></a>
                        </div>
                    </div>
                </div>
            </div>
