...
<title>Formation Coloration & Mèches - Progress Professionnel Center</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
<style>
:root { --accent: #ff7f50; --accent-2: #ff4500; --bg-light: #fdfdfd; --text-dark: #2d2d2d;}
body { font-family: 'Poppins', sans-serif; background: var(--bg-light); color: var(--text-dark);}
.hero { background:url('img/coloration.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Coloration & Mèches</h1>
    <p>Apprenez les techniques professionnelles pour des résultats parfaits</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Cette formation vous permettra de maîtriser toutes les techniques de coloration et mèches, 
          en respectant les tendances et le type de cheveux de vos clients.
        </p>
      </div>
    </div>
    <img src="img/coloration2.jpg" alt="Coloration & Mèches" class="img-fluid rounded shadow mt-4" style="max-width:600px; width:100%; height:auto;">
  </section>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-md-5">
        <div class="card card-option">
          <div class="card-header">Formation accéléré</div>
          <div class="card-body">
            <p>Durée : <strong>1 mois</strong></p>
            <p class="price">300 TND</p>
            <p>Apprentissage rapide des bases de la coloration et mèches.</p>
          </div>
        </div>
      </div>
        </div>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-coloration-meches.php" method="post">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="option" name="option" required>
              <option value="express">accéléré (1 mois) - 300TND</option>
            </select>
          </div>
          <input type="hidden" name="formation" value="Coloration & Mèches">
