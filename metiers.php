                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item"><a class="text-white" href="#">Domaines</a></li>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">DOMAINE METIERS</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="patronage.php" class="dropdown-item">
                                <img class="img-fluid" src="img/cou/1.jpg" alt="anglais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="patronage.php" >
                                <h5 class="mb-0">Patronage</h5>
                                <small>PACK FORMATION</small>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="esthetique.php" class="dropdown-item">
                                <img class="img-fluid" src="img/cou/6.png" alt="francais">
                            </a>
                        </div>
                        <div class="text-center p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="coifhomme.php" class="dropdown-item">
                                <img class="img-fluid" src="img/cou/3.jpg" alt="espagnol">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="coifhomme.php" >
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="coiffemme.php" class="dropdown-item">
                                <img class="img-fluid" src="img/cou/2.jpg" alt="italien">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="coiffemme.php" >
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="tatouage.php" class="dropdown-item">
                                <img class="img-fluid" src="img/cou/4.jpg" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="tatouage.php" >
                ...
                <div class="col-lg-3 ²col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="patisserie.php" class="dropdown-item">
                                <img class="img-fluid" src="img/cou/12.png" alt="Allemand">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="patisserie.php" >
                                <h5 class="mb-0">Patisserie</h5>
                                <small>PACK FORMATION</small>
                            </a>
                        </div>
                    </div>
