        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">ESPAGNOL</h1>
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/14.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        ...
                        <h5 class="mb-4">Cours intensif d'espagnol</h5>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/15.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        ...
                        <h5 class="mb-4">Coaching privé espagnol</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h2 class="section-title bg-white text-center text-primary px-3">Inscription au cours d'espagnol</h2>
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                <form action="save_inscription_espagnol.php" method="POST" class="bg-light p-4 shadow rounded">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="option_formation" class="form-label">Type de formation</label>
                        <select class="form-select" id="option_formation" name="option_formation" required>
                            <option value="">Sélectionnez une option</option>
                            <option value="Intensif 30h">Intensif 30h</option>
