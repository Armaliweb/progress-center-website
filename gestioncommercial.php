        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">GESTION COMMERCIAL</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Formation Gestion Commerce </h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Le Centre Progress Profisionnel vous offre une formation de haut niveau; comprendre les bases de la gestion commercial et maîtriser les logiciels pratiques Ciel et Sage.</p>
            </section>
            ...
            <section class="niveau-demande">
                <h4>Certification</h4>
                 <p>✅FORMATION SAGE COMMERCIAL</p>
                 <p>✅FORMATION CIEL COMMERCIAL</p>       
            </section>
