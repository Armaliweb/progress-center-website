...
<?php endif; ?>
    ...
    <style>
        ...
        .team-item:hover {
            ...
            box-shadow: 0 8px 16px rgba(0, 0, 0, 0.2); /* Amélioration de l'ombre */
        }
        ...
        h5 {
            color: #1e90ff;
            font-size: 20px; /* Agrandissement de la police */
            margin: 10px 0;
        }
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                    <!-- Image 1 -->
                    <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                        <div class="team-item bg-light">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src="img/image1.jpg" alt="Image 1">
                            </div>
                            <div class="text-center p-4">
                                <h5 class="mb-0">Image 1</h5>
                            </div>
                        </div>
                    </div>
                    <!-- Image 2 -->
                    <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.2s">
                        <div class="team-item bg-light">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src="img/image2.jpg" alt="Image 2">
                            </div>
                            <div class="text-center p-4">
                                <h5 class="mb-0">Image 2</h5>
                            </div>
                        </div>
                    </div>
                    <!-- Image 3 -->
                    <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.3s">
                        <div class="team-item bg-light">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src="img/image3.jpg" alt="Image 3">
                            </div>
                            <div class="text-center p-4">
                                <h5 class="mb-0">Image 3</h5>
                            </div>
                        </div>
                    </div>
                    <!-- Image 4 -->
                    <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.4s">
                        <div class="team-item bg-light">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src="img/image4.jpg" alt="Image 4">
                            </div>
                            <div class="text-center p-4">
                                <h5 class="mb-0">Image 4</h5>
                            </div>
                        </div>
                    </div>
                    <!-- Image 5 -->
                    <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                        <div class="team-item bg-light">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src="img/image5.jpg" alt="Image 5">
                            </div>
                            <div class="text-center p-4">
                                <h5 class="mb-0">Image 5</h5>
                            </div>
                        </div>
                    </div>
                    <!-- Image 6 -->
                    <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.6s">
                        <div class="team-item bg-light">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src="img/image6.jpg" alt="Image 6">
                            </div>
                            <div class="text-center p-4">
                                <h5 class="mb-0">Image 6</h5>
                            </div>
                        </div>
                    </div>
                    <!-- Image 7 -->
                    <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.7s">
                        <div class="team-item bg-light">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src="img/image7.jpg" alt="Image 7">
                            </div>
                            <div class="text-center p-4">
                                <h5 class="mb-0">Image 7</h5>
                            </div>
                        </div>
                    </div>
                                   <!-- Image 8 -->
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.8s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/image8.jpg" alt="Image 8">
                        </div>
                        <div class="text-center p-4">
                            <h5 class="mb-0">Image 8</h5>
                        </div>
                    </div>
                </div>
                <!-- Image 9 -->
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.9s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/image9.jpg" alt="Image 9">
                        </div>
                        <div class="text-center p-4">
                            <h5 class="mb-0">Image 9</h5>
                        </div>
                    </div>
                </div>
                <!-- Image 10 -->
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="1.0s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/image10.jpg" alt="Image 10">
                        </div>
                        <div class="text-center p-4">
                            <h5 class="mb-0">Image 10</h5>
                        </div>
                    </div>
                </div>
                <!-- Image 11 -->
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="1.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/image11.jpg" alt="Image 11">
                        </div>
                        <div class="text-center p-4">
                            <h5 class="mb-0">Image 11</h5>
                        </div>
                    </div>
                </div>
                <!-- Image 12 -->
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="1.2s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/image12.jpg" alt="Image 12">
                        </div>
                        <div class="text-center p-4">
                            <h5 class="mb-0">Image 12</h5>
                        </div>
                    </div>
                </div>
                <!-- Image 13 -->
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="1.3s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/image13.jpg" alt="Image 13">
                        </div>
                        <div class="text-center p-4">
                            <h5 class="mb-0">Image 13</h5>
                        </div>
                    </div>
                </div>
                <!-- Image 14 -->
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="1.4s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/image14.jpg" alt="Image 14">
                        </div>
                        <div class="text-center p-4">
                            <h5 class="mb-0">Image 14</h5>
                        </div>
                    </div>
                </div>
                <!-- Image 15 -->
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="1.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/image15.jpg" alt="Image 15">
                        </div>
                        <div class="text-center p-4">
                            <h5 class="mb-0">Image 15</h5>
                        </div>
                    </div>
                </div>
            </div>
