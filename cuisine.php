        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Cuisine</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Formation Pâtisserie</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Développez vos talents culinaires avec notre formation exhaustive en cuisine, qui vous plonge dans les secrets des techniques de cuisson, la maîtrise des saveurs et la présentation de plats raffinés. Apprenez à préparer une variété de recettes, à utiliser les ingrédients de manière innovante, et à adopter des pratiques professionnelles en cuisine, tout en recevant des conseils pratiques et des astuces de chefs expérimentés pour transformer votre passion pour la cuisine en expertise reconnue.</p>
            </section>
