...
<head>
    <meta charset="utf-8">
    <title>MONTAGE SON ET VIDÉO</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">MONTAGE SON ET VIDÉO
                    </h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>FORMATION MONTAGE SON ET VIDÉO</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Devenir professionnel en montage vidéo et son en appliquant les logiciels les plus pratiqués dans ce domaine.
                    Apprendre les outils des logiciels adobe premier, audition et after effect en réalisant des projets média.
                    </p>
            </section>
            ...
            <section class="niveau-demande">
                <h4>Certification</h4>
                 <p>✅ FORMATION ADOBE PREMIERE
                </p>
              <P>  ✅ FORMATION AUDITION</P>

                <P>✅ FORMATION AFTER EFFECT
                </P>
                <p>✅ FORMATION MONTEUR SON ET VIDÉO
                </p>
