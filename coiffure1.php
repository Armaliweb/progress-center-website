...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO inscriptions_coiffure (nom, prenom, email, tel, formation, type) 
...
<title>Formation Coiffure Continue - Progress Center</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
<style>
:root { --accent:#8e44ad; --accent-2:#9b59b6; --bg-light:#fdfdfd; --text-dark:#2d2d2d; }
body{font-family:'Poppins',sans-serif;background:var(--bg-light);color:var(--text-dark);}
.hero{background:url('img/coif4.jpg') center/cover no-repeat;height:420px;display:flex;align-items:center;justify-content:center;color:white;text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Coiffure (Continue)</h1>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">Nos formations continues en coiffure permettent une maîtrise complète et progressive.</p>
      </div>
    </div>
    <img src="img/coif3.jpg" alt="Formation Coiffure Continue" class="img-fluid rounded shadow mt-4" style="max-width:400px;">
  </section>
    ...
    <div class="col-md-4">
      <div class="card card-option">
        ...
        <div class="card-body">
          ...
          <p>Apprentissage complet des bases de la coiffure.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card card-option">
        ...
        <div class="card-body">
          ...
          <p>Approfondissement et pratique régulière.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card card-option">
        ...
        <div class="card-body">
          ...
          <p>Programme complet pour devenir professionnel.</p>
        </div>
      </div>
    </div>
