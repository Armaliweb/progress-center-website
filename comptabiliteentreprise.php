...
<head>
    <meta charset="utf-8">
    <title>COMPTABLE D’ENTREPRISE</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">COMPTABLE D’ENTREPRISE</h1>
                    </div>
            </div>
        </div>
    </div>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>DIPLÔME COMPTABLE D’ENTREPRISE</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Progress Professional center vous offre le diplôme comptable d’entreprise.</p>
            </section>
