...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Diplôme Infographie PAO</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Le Centre Progress Professionnel vous offre la possibilité d'obtenir un diplôme en Infographie, reconnu et homologué par les autorités compétentes. Ce diplôme atteste de votre expertise en infographie et est un atout majeur pour votre carrière dans le domaine du design graphique.</p>
            </section> 
            <section class="duree">
                <h4>Durée</h4>
                <p>9 mois</p>
