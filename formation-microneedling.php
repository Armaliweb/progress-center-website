...
<title>Formation Microneedling - Progress Professionnel Center</title>
...
.hero { background:url('img/microneedling.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Microneedling</h1>
    <p>Maîtrisez les techniques avancées de microneedling pour une peau éclatante</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Formation professionnelle pour apprendre le microneedling, 
          traitement anti-âge et protocoles de soin de la peau avec sécurité et efficacité.
        </p>
      </div>
    </div>
    <img src="img/microneedling2.jpg" alt="Microneedling" class="img-fluid rounded shadow mt-4" style="max-width:600px; width:100%; height:auto;">
  </section>
      ...
      <div class="col-md-5">
        <div class="card card-option">
          ...
          <div class="card-body">
            ...
            <p class="price">300TND au lieu de 600TND</p>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-microneedling.php" method="post">
          <div class="mb-3">
          ...
          <input type="hidden" name="formation" value="Microneedling">
