...
<head>
    <meta charset="utf-8">
    <title>COMMERCIAL EN AGENCE DE VOYAGE</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown"> COMMERCIAL EN AGENCE DE VOYAGE</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Formation Commercial en Agence de Voyage</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Le Centre Progress Profisionnel  Devenir commercial en agence de voyage et apprendre a commercialisé les services touristiques, hôtelière et aérienne et maîtrisé les langues vivantes, les techniques de communication et commercial et notamment le logiciel de billetterie et de réservation Amadeus.</p>
            </section>
            ...
            <section class="niveau-demande">
                <h4>Certification</h4>
                 ...
                 <p>✅ ANGLAIS DE COMMUNICATION</p>    
                 <p>✅ TECHNIQUES COMMERCIALES</p> 
                  <p>✅ FORMATION AMADEUS</p>     
            </section>
