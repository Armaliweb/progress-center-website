        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">ITALIEN</h1>
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/16.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">300<sup>TND</sup></h6>
                        ...
                        <h5 class="mb-4">Cours intensif d'italien</h5>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/17.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h6 class="mb-0">300<sup>TND</sup></h6>
                        <p class="text-muted mb-3">
                        ...
                        <h5 class="mb-4">Cours extensif d'italien</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>30 Hrs</small>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="course-item bg-light shadow-sm">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/LG/18.jpg" alt="">
                    </div>
                    <div class="text-center p-4 pb-0">
                        ...
                        <h5 class="mb-4">Coaching privé italien</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Présentiel</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>Selon votre choix</small>
                        <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>Selon votre choix</small>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp mb-4">
            <h2 class="section-title bg-white text-center text-primary px-3">Inscrivez-vous au cours d'Italien</h2>
        </div>
        <form action="save_inscription_italien.php" method="POST" class="row g-3 justify-content-center">
            <div class="col-md-4">
                <input type="text" name="nom" class="form-control py-3" placeholder="Votre Nom" required>
            </div>
            <div class="col-md-4">
                <input type="email" name="email" class="form-control py-3" placeholder="Votre Email" required>
            </div>
            <div class="col-md-4">
                <input type="text" name="telephone" class="form-control py-3" placeholder="Votre Téléphone" required>
            </div>
            <div class="col-md-4">
                <select name="option_formation" class="form-select py-3" required>
                    <option value="" disabled selected>Choisir une option</option>
                    <option value="Cours intensif">Cours intensif</option>
                    <option value="Cours extensif">Cours extensif</option>
