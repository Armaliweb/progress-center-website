...
<title>Formation Lash Lift - Progress Professionnel Center</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
<style>
:root { --accent: #ff8c94; --accent-2: #c779d0; --bg-light: #fdfdfd; --text-dark: #2d2d2d;}
body { font-family: 'Poppins', sans-serif; background: var(--bg-light); color: var(--text-dark);}
.hero { background:url('img/lashlift.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Lash Lift</h1>
    <p>Apprenez la technique du rehaussement de cils pour un regard plus intense et naturel.</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Cette formation professionnelle vous permettra de maîtriser le **rehaussement des cils (Lash Lift)**,
          une technique innovante pour sublimer le regard de vos clientes naturellement et sans extensions.
        </p>
      </div>
    </div>
    <img src="img/lashlift2.jpg" alt="Lash Lift" class="img-fluid rounded shadow mt-4" style="max-width:400px; width:100%; height:auto;">
  </section>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-lashlift.php" method="post">
          <div class="mb-3">
          ...
          <input type="hidden" name="formation" value="Lash Lift">
