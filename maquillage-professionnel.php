...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $age = (int)$_POST['age'];
    $email = $conn->real_escape_string($_POST['parcours']);
    $option = $conn->real_escape_string($_POST['option']);
    $formation = $conn->real_escape_string($_POST['formation']);

    $sql = "INSERT INTO inscriptions_maquillage (nom, age, email, option_formation, formation) 
            VALUES ('$nom', $age, '$email', '$option', '$formation')";
...
<title>Maquillage Professionnel - Progress Professionnel Center</title>
...
.hero { background:url('img/maquillage-hero.jpg') center/cover no-repeat; height: 420px; display: flex; align-items: center; justify-content: center; color: white; text-align: center;}
...
footer { background: #fafafa; padding: 20px; font-size: 0.9rem; color: #555;}
...
<header class="hero">
  <div>
    <h1>Formation Maquillage Professionnel</h1>
    <p>Apprenez les techniques modernes de maquillage pour tous types de peau et occasions</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Une formation complète pour maîtriser le maquillage professionnel : teint, yeux, lèvres, 
          maquillage artistique et événements spéciaux. Convient aux débutants et aux professionnels souhaitant se perfectionner.
        </p>
      </div>
    </div>
    <img src="img/maquillage1.jpg" alt="Maquillage Professionnel" class="img-fluid rounded shadow mt-4" style="max-width: 400px; height: auto;">
  </section>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-md-5">
        <div class="card card-option">
          ...
          <div class="card-body">
            <p>Durée : <strong>1 mois intensif</strong></p>
            <p class="price">250TND au lieu de 500TND</p>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <form action="" method="post">
          ...
          <input type="hidden" name="formation" value="Maquillage Professionnel">
...
<?php
include 'config.php';
$result = mysqli_query($conn, "SELECT * FROM commentaires WHERE statut='approved' ORDER BY created_at DESC");
