...
<title>Formation Microblading - Progress Professionnel Center</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
<style>
:root { --accent: #e85d04; --accent-2: #9d0208; --bg-light: #fdfdfd; --text-dark: #2d2d2d;}
body { font-family: 'Poppins', sans-serif; background: var(--bg-light); color: var(--text-dark);}
.hero { background:url('img/microblading.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Microblading</h1>
    <p>Apprenez l’art du microblading pour offrir des sourcils parfaits et naturels</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Cette formation vous permettra de maîtriser les techniques du microblading,
          du tracé à la pigmentation, afin de garantir un rendu naturel et harmonieux.
        </p>
      </div>
    </div>
    <img src="img/microblading2.jpg" alt="Microblading" class="img-fluid rounded shadow mt-4" style="max-width:600px; width:100%; height:auto;">
  </section>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-microblading.php" method="post">
          <div class="mb-3">
          ...
          <input type="hidden" name="formation" value="Microblading">
