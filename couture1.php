...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO inscriptions_couture (nom, prenom, email, tel, formation, type) 
            VALUES ('$nom', '$prenom', '$email', '$tel', '$formation', 'continue')";
...
<title>Formation Couture Continue - Progress Center</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
<style>
:root { --accent:#e74c3c; --accent-2:#ff6b6b; --bg-light:#fdfdfd; --text-dark:#2d2d2d; }
body{font-family:'Poppins',sans-serif;background:var(--bg-light);color:var(--text-dark);}
.hero{background:url('img/couture5.jpg') center/cover no-repeat;height:420px;display:flex;align-items:center;justify-content:center;color:white;text-align:center;}
...
.card-option{border:none;border-radius:18px;overflow:hidden;transition:.3s;background:white;}
.card-option:hover{transform:translateY(-8px);box-shadow:0 15px 30px rgba(0,0,0,0.15);}
.card-header{background:linear-gradient(135deg,var(--accent),var(--accent-2));color:white;text-align:center;font-size:1.3rem;font-weight:600;padding:20px;}
.card-body{text-align:center;padding:30px;}
p.price{font-size:1.6rem;font-weight:700;color:var(--accent-2);}
...
<header class="hero">
  <div>
    <h1>Formation Couture (Continue)</h1>
    <p>Un programme approfondi et suivi sur plusieurs mois</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">Nos formations continues en couture permettent une maîtrise complète et progressive, de la conception à la réalisation.</p>
      </div>
    </div>
    <img src="img/couture4.jpg" alt="Formation Couture Continue" class="img-fluid rounded shadow mt-4" style="max-width:400px;">
  </section>

  <section>
  <h2 class="section-title">Nos formules continues</h2>
    ...
    <div class="col-md-4">
      <div class="card card-option">
        ...
        <div class="card-body">
          ...
          <p>Bases solides de la couture et techniques essentielles.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card card-option">
        ...
        <div class="card-body">
          ...
          <p class="price">200TND</p>
          <p>Approfondissement des techniques et création de projets personnels.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card card-option">
        ...
        <div class="card-body">
          ...
          <p class="price">180TND</p>
          <p>Programme complet pour devenir un professionnel de la couture.</p>
        </div>
      </div>
    </div>
