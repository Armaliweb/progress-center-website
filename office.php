        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">MICROSOFT OFFICE</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>Formation Microsoft Office</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p>Microsoft Office est une suite bureautique complète et incontournable qui offre un ensemble d'outils puissants tels que Word, Excel, PowerPoint, et Outlook, conçus pour améliorer la productivité, faciliter la collaboration, et répondre aux besoins professionnels et personnels. Avec ses fonctionnalités avancées, son interface intuitive, et son intégration fluide avec les services cloud, Microsoft Office permet aux utilisateurs de créer, partager, et gérer efficacement leurs documents, feuilles de calcul, présentations, et communications, tout en restant connectés et productifs où qu'ils soient.</p>
            </section>
        ...
        <!-- Add this inside your <body> container, below the Microsoft Office section -->

<div class="container mt-5">
    <h3>Formation Excel Avancé</h3>
    <br><br>

    <section class="description">
        <h4>Description</h4>
        <p>Excel Avancé permet de maîtriser les fonctions avancées d'Excel, telles que les tableaux croisés dynamiques, les formules complexes, la gestion des données, les macros et l'automatisation, pour améliorer votre productivité et vos analyses de données.</p>
    </section>

    <section class="niveau-demande">
        <h4>Certification</h4>
        <p>✅TABLEAUX CROISÉS DYNAMIQUES</p>
        <p>✅FORMULES AVANCÉES</p>
        <p>✅MACROS & AUTOMATISATION</p>
    </section>
    ...
    <button class="pre-inscription" id="openModalBtnExcel" style="background-color: #28a745; color: #fff; border: none; padding: 10px 20px; border-radius: 4px; cursor: pointer; font-size: 16px;">Pré-Inscription</button>
</div>

<!-- Modal already exists, so we just need to set the dynamic title for Excel -->
<script>
    var modal = document.getElementById("myModal");
    var btnExcel = document.getElementById("openModalBtnExcel");
    var btnMicrosoft = document.getElementById("openModalBtn");
    var span = document.getElementById("closeModalBtn");

    btnMicrosoft.onclick = function() {
        modal.style.display = "block";
        modal.querySelector("h2").innerText = "Pré-Inscription Microsoft Office";
    }

    btnExcel.onclick = function() {
        modal.style.display = "block";
        modal.querySelector("h2").innerText = "Pré-Inscription Excel Avancé";
    }
