        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">COMPTABILITE</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Comptabilité</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="section-title bg-white text-center text-primary px-3">DOMAINE COMPTABILITE & FINANCE</h4>
            </div>
            <br><br>
            <div class="row g-4" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="comptabiliteentreprise.php" class="dropdown-item">
                                <img class="img-fluid" src="img/comptabilite.jpg" alt="Infographie Design">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="comptabiliteentreprise.php" >
                                <h5 class="mb-0">COMPTABLE D’ENTREPRISE</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" style="flex: 1 1 350px; max-width: 350px;" data-wow-delay="0.5s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <a href="comptabilitefinance.php" class="dropdown-item">
                                <img class="img-fluid" src="img/finance.jpg" alt="Marketing & Multimédia">
                            </a>
                        </div>
                        <div class="text-center p-4">
                            <a href="comptabilitefinance.php" >
                                <h5 class="mb-0">COMPTABILITÉ & FINANCE</h5>
                            </a>
                        </div>
                    </div>
                </div>
