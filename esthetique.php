...
<head>
    <meta charset="UTF-8">
    <title>Esthétique - Choix de Formation</title>
    ...
    <style>
        ...
        .hero {
            background: url('img/eshero.jpg') center/cover no-repeat;
            height: 350px;
            position: relative;
            color: white;
            display: flex;
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-5">
            <div class="card choice-card">
                <img src="img/acce.jpg" alt="Formation Accélérée">
                <div class="card-body">
                    <h4 class="card-title">Formation Accélérée</h4>
                    <p>Apprenez rapidement toutes les techniques professionnelles d'esthétique.</p>
                    <a href="esthetique2.php" class="btn btn-primary">Choisir</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="card choice-card">
                <img src="img/cont.jpg" alt="Formation Continue">
                <div class="card-body">
                    <h4 class="card-title">Formation Continue</h4>
                    <p>Suivez les cours à votre rythme et approfondissez vos compétences en esthétique.</p>
                    <a href="esthetique1.php" class="btn btn-primary">Choisir</a>
                </div>
            </div>
        </div>
