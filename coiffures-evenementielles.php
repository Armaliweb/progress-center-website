...
<title>Formation Coiffures Événementielles - Progress Professionnel Center</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
<style>
/* Styles identiques aux autres pages */
:root { --accent: #00b4d8; --accent-2: #0077b6; --bg-light: #fdfdfd; --text-dark: #2d2d2d;}
body { font-family: 'Poppins', sans-serif; background: var(--bg-light); color: var(--text-dark);}
.hero { background:url('img/coiffures-evenementielles.jpg') center/cover no-repeat; height: 420px; display:flex; align-items:center; justify-content:center; color:white; text-align:center;}
...
<header class="hero">
  <div>
    <h1>Formation Coiffures Événementielles</h1>
    <p>Maîtrisez l’art des coiffures pour mariages, soirées et événements spéciaux</p>
  </div>
</header>
...
<main class="container">
  ...
  <section class="text-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <p class="lead">
          Formation complète pour apprendre toutes les techniques de coiffures événementielles,
          adaptées à différents styles et occasions.
        </p>
      </div>
    </div>
    <img src="img/coiffures2.jpg" alt="Coiffures Événementielles" class="img-fluid rounded shadow mt-4" style="max-width:600px; width:100%; height:auto;">
  </section>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-md-5">
        <div class="card card-option">
          <div class="card-header">Formation Intensive</div>
          <div class="card-body">
            <p>Durée : <strong>2 mois intensifs</strong></p>
            <p class="price">350TND</p>
            <p>Apprentissage rapide des coiffures événementielles les plus demandées.</p>
          </div>
        </div>
      </div>
        </div>
  ...
  <section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <?php endif; ?>
        <form action="submit-coiffures-evenementielles.php" method="post">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="option" name="option" required>
              <option value="intensive">Intensive (2 mois) - 350TND</option>
            </select>
          </div>
          <input type="hidden" name="formation" value="Coiffures Événementielles">
