        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">MARKETING & MULTIMEDIA</h1>
...
input[type="submit"]:hover {
    ...
    <body>
        <div class="container">
            <h3>DIPLÔME MARKETING DIGITAL : <br>
                MARKETING ET MULTIMEDIA</h3>
            <br> <br>
            
            <section class="description">
                <h4>Description</h4>
                <p> PROGRESS PROFESSIONAL vous offre un diplôme en marketing digital et multimedia. Un programme très riche développé par nos experts pour vous préparer aux différents domaines du digital, comme le coding full stack et le développement web, le marketing et la publicité sur réseaux sociaux, le référencement web, l’infographie design, le web-marketing et le multimedia.</p>
            </section>
            ...
            <section class="metiers">
                ...
                <ul>
                    ...
                    <li>Intégrateur web / Développeur front-end</li>
